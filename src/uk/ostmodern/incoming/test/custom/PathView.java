...
public class PathView extends View implements Animator.AnimatorListener{
    ...
    private static final int DEFAULT_PATH_STROKE_COLOR = Color.argb(40,245,245,200);
...
//    private MaskFilter  mEmboss;
    ...
    public PathView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        paint.setStrokeWidth(attributes.getDimension(R.styleable.PathView_path_stroke_width, DEFAULT_PATH_STROKE_WITH));
...
//        this.mEmboss = new EmbossMaskFilter(new float[] { 1, 1, 1 }, 0.4f, 6, 3.5f);
        ...
        viewPadding = (VIEW_PADDING * getContext().getResources().getDisplayMetrics().density);
